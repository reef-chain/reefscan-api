...
export default {
  ...
  letsexchangeBaseUrl: process.env.LETSEXCHANGE_API_URL || 'https://api.letsexchange.io/api',
  letsexchangeApiKey: process.env.LETSEXCHANGE_API_TOKEN || '',
  letsexchangeAffiliateId: process.env.LETSEXCHANGE_AFFILIATE_ID || '',
